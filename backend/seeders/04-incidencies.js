...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const incidencies = [
      ...
      { unitfleet: 3007, dni_emp: "88888888H", incidence_type: "Mecánica", description: "Vibración en la dirección a baja velocidad.", date: new Date(), status: "Pendiente", createdAt: new Date(), updatedAt: new Date() },
      ...
      { unitfleet: 1008, dni_emp: "12121212J", incidence_type: "Paciente", description: "Paciente mareado durante traslado.", date: new Date(), status: "Pendiente", createdAt: new Date(), updatedAt: new Date() },
      { unitfleet: 2005, dni_emp: "10101010K", incidence_type: "Paciente", description: "Atención por hipoglucemia.", date: new Date(), status: "Resuelta", createdAt: new Date(), updatedAt: new Date() },
      { unitfleet: 3009, dni_emp: "20202020L", incidence_type: "Paciente", description: "Paciente con dolor torácico.", date: new Date(), status: "En proceso", createdAt: new Date(), updatedAt: new Date() },
      ...
      { unitfleet: 2008, dni_emp: "22222222B", incidence_type: "Servicio", description: "Coordinación con central completada.", date: new Date(), status: "Resuelta", createdAt: new Date(), updatedAt: new Date() },
      { unitfleet: 3004, dni_emp: "30303030M", incidence_type: "Servicio", description: "Conflicto con paciente durante traslado.", date: new Date(), status: "Pendiente", createdAt: new Date(), updatedAt: new Date() },

      // 🟦 FACULTATIVOS
      { unitfleet: 4007, dni_emp: "99999999I", incidence_type: "Paciente", description: "Paciente con reacción alérgica severa.", date: new Date(), status: "Pendiente", createdAt: new Date(), updatedAt: new Date() },
      { unitfleet: 2009, dni_emp: "13131313T", incidence_type: "Paciente", description: "Paciente inconsciente, valoración avanzada.", date: new Date(), status: "En proceso", createdAt: new Date(), updatedAt: new Date() },

      // 🟧 OTRO (cualquiera)
      { unitfleet: 1006, dni_emp: "18181818Y", incidence_type: "Otro", description: "Problemas con el GPS de la unidad.", date: new Date(), status: "Pendiente", createdAt: new Date(), updatedAt: new Date() },
